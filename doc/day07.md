...
* **Pattern Matching**: Uso de sentencias `switch` modernas para determinar el comportamiento del flujo según el carácter del mapa (`^`, `default`), mejorando la legibilidad.
